...
return array(
	...
	'categorias' => [
		...
		'REPUESTOS' => 'REPUESTOS',
		'MATERIALES DE CONSUMO' => 'MATERIALES DE CONSUMO',
	],
	'inventory' => [
		'col_1' => [
			'Vasos de ruedas',
	...
	'eva_interior' => [
		...
		'ASIENTOS POSTERIORES TAPIZ' => ['LH', 'CENT', 'RH', 'comment'],
		'ASIENTOS POSTERIORES CABECERA' => ['LH', 'CEN', 'RH', 'comment'],
		'3RA FILA TAPIZ' => ['LH', 'RH', 'comment'],
		'3RA FILA CABECERA' => ['LH', 'RH', 'comment'],
		'3RA FILA CABECERA' => ['LH', 'RH', 'comment'],
		'TAPIZ PUERTAS DEL.' => ['LH', 'RH', 'comment'],
		'TAPIZ PUERTAS POST.' => ['LH', 'RH', 'comment'],
		'TAPIZ TERCERA FILA' => ['LH', 'RH', 'comment'],
		'JEBES PUERTA DEL.' => ['LH', 'RH', 'comment'],
		'JEBES PUERTA POST.' => ['LH', 'RH', 'comment'],
		'JEBES COMPUERTA' => ['status', 'comment'],
		'JEBE DE PUERTAS EN CHASIS' => ['DLH', 'DRH', 'PLH', 'PLH', 'comment'],
		'CONSOLA CENTRAL' => ['status', 'comment'],
		'PALANCA DE CAMBIOS' => ['status', 'comment'],
		'CINTURONES DELANTEROS' => ['LH', 'RH', 'comment'],
		'CINTURONES POSTERIORES' => ['LH', 'RH', 'comment'],
		'CINTURONES TERCERA FILA' => ['LH', 'RH', 'comment'],
		'FUNCIONAMIENTO DE LUNAS Y CREMALLERAS' => ['DLH', 'DRH', 'PLH', 'PLH'],
		'GUANTERA' => ['status', 'comment'],
		'TABLERO' => ['status', 'comment'],
		'TIMON' => ['status', 'comment'],
		'TAPASOLES' => ['status', 'comment'],
		'TAPA DE FUSIBLES' => ['status', 'comment'],
		'RADIO' => ['status', 'comment'],
		'ESPEJO INTERIOR' => ['status', 'comment'],
		'CIELO RASO' => ['status', 'comment'],
		'ALFOMBRAS' => ['status', 'comment'],
		'LLAVES DE CONT. (CANT.)' => ['status', 'comment'],
		'OPERACION TIMÓN' => ['status', 'comment'],
		'OPERACION PUERTAS' => ['LH', 'RH', 'comment'],
		'OPERACION 3RA/MALET.' => ['status', 'comment'],
		'HERRAMIENTAS' => ['GATA', 'LLV. RUED.', 'LL. REP.', 'comment'],
	],
	'eva_exterior' => [
		'LLANTAS' => ['status', 'comment'],
		'AROS' => ['status', 'comment'],
		'VASOS / COPITAS' => ['status', 'comment'],
		'TUERCAS' => ['status', 'comment'],
		'ESCARPINES' => ['DLH', 'DRH', 'PLH', 'PRH', 'comment'],
		'ANTENA' => ['status', 'comment'],
		'BRASOS DE PLUMILLA' => ['status', 'comment'],
		'PLUMILLAS' => ['status', 'comment'],
		'ESPEJOS EXTERIORES' => ['status', 'comment'],
		'FUNDA DELANTERA' => ['status', 'comment'],
		'FAROS PRINCIPALES' => ['status', 'comment'],
		'FAROS NEBLINEROS' => ['status', 'comment'],
		'MASCARA' => ['status', 'comment'],
		'FUNDA POSTERIOR' => ['status', 'comment'],
		'FAROS POSTERIORES' => ['status', 'comment'],
		'FAROS EN LA FUNDA' => ['status', 'comment'],
		'3RA. LUZ DE FRENO' => ['status', 'comment'],
		'LUNA PARABRISAS' => ['DEL', 'POST', 'comment'],
		'LUNA PUERTAS' => ['status', 'comment'],
		'JEBES LAME LUNAS' => ['status', 'comment'],
		'MANDILES PLASTICOS DEL.' => ['LH', 'RH', 'comment'],
		'MANDILES PLASTICOS POST.' => ['LH', 'RH', 'comment'],
		'MANDILES PLASTICOS BAJO MOTOR' => ['status', 'comment'],
	],
	'eva_planchado' => [
		'PLANCHADO' => ['price', 'comment'],
	],
	'eva_pintura' => [
		'BAÑO DE PINTURA' => ['price', 'comment'],
	],
);
