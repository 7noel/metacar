...
class AdminTableSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        PaymentCondition::create(['my_company' => 1, 'name' => 'CONTADO', 'days' => 0]);
        PaymentCondition::create(['my_company' => 1, 'name' => 'CRÉDITO 15', 'days' => 15]);
        PaymentCondition::create(['my_company' => 1, 'name' => 'CRÉDITO 30', 'days' => 30]);
        PaymentCondition::create(['my_company' => 1, 'name' => 'CRÉDITO 45', 'days' => 45]);
        PaymentCondition::create(['my_company' => 1, 'name' => 'CRÉDITO 60', 'days' => 60]);
