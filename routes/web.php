...
Route::group(['prefix'=>'operations', 'middleware'=>['auth', 'permissions'], 'namespace'=>'Operations'], function(){
	...
	Route::get('output_orders/by_car/{car_id}', ['as' => 'output_orders.by_car', 'uses' => 'OrdersController@createByCar']);
	...
	Route::get('output_quotes/by_order/{order_id}', ['as' => 'output_quotes.by_order', 'uses' => 'OrdersController@byOrder']);
