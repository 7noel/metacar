...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<h5 class="{{ config('options.styles.card_header') }}">CAMBIAR ESTADO DE ORDEN #{{ $model->sn }}
				</h5>
				<div class="card-body">
					{!! Form::model($model, ['route'=> ['update_status_order', $model] , 'method'=>'PUT', 'class'=>'', 'enctype'=>"multipart/form-data"]) !!}
						...
						<div class="form-row">
							<div class="col-md-4 col-sm-6">
								{!! Field::select('status', config('options.order_status_'.$model->status) , null, ['label' => 'Siguiente Status', 'class'=>'form-control-sm text-uppercase', 'required']) !!}
							</div>
						</div>
